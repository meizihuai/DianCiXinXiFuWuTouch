...
Public Class loginfrm
    ...
    Dim title As String = "电磁信息云服务触屏版 登录 " & Version
    ...
    Private Sub JianCha()
        ...
        logLable.Location = New Point(222, 430)
    ...
    Private Sub HandleUpdate()
        ...
        sw.Write(exeName)
        sw.Close()
        Dim updateurl As String = "http://123.207.31.37:8080/?func=autoUpdate&updateFunc=getupdate&exename=电磁信息云服务触屏版.exe&version=" & Version
