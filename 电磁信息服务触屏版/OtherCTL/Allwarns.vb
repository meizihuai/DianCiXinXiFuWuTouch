...
Public Class Allwarns
                ...
                If msg <> "" Then
                    ...
                    For Each warn In list
                        If InStr(warn, "WARN") Then
                            ...
                            If st(2) = "GR" Then
                                str = "即时告警<br>微型传感器:" & deviceName & "<br>在" & address & "<br>上报" & lx & "预警" & "<br>频率: " & st(7) & "MHz<br>场强: " & st(8) & "dBm" & "<br>超标: " & st(9) & " %" & "<br>干扰: " & st(10) & " 次" & "<br>预警时间:" & Now.ToString("yyyy-MM-dd HH:mm:ss")
                            Else
                                str = "即时告警<br>微型传感器:" & deviceName & "<br>在" & address & "<br>上报" & lx & "预警" & "<br>频率: " & st(7) & "MHz<br>场强: " & st(8) & "dBm" & "<br>超标: " & st(9) & " %" & "<br>预警时间:" & Now.ToString("yyyy-MM-dd HH:mm:ss")
                            End If
                            ...
                            If CheckBox1.Checked Then
                                ...
                                warnSpeekMsg = "微型传感器" & deviceName & ",在" & address.Replace(",", "") & "上报" & lx & "预警," & "频率" & st(7) & "MHz"
                                speek(warnSpeekMsg)
                            End If
                        End If
                    Next
    ...
    Private Sub lvdetailBeSelect(ByVal index As Integer)
        ...
        If InStr(strTmp, "WARN") Then
            ...
            If st(2) = "GR" Then
                str = "微型传感器:" & deviceName & "<br>在" & address & "<br>上报" & lx & "预警" & "<br>频率: " & st(7) & "MHz<br>场强: " & st(8) & "dBm" & "<br>超标: " & st(9) & " %" & "<br>干扰: " & st(10) & " 次"
            Else
                str = "微型传感器:" & deviceName & "<br>在" & address & "<br>上报" & lx & "预警" & "<br>频率: " & st(7) & "MHz<br>场强: " & st(8) & "dBm" & "<br>超标: " & st(9) & " %"
            End If
            script("cleanall", New String() {}, WebGis)
            script("addpoint", New String() {lng, lat, "", True}, WebGis)
            script("showWindowMsg", New String() {lng, lat, str, True}, WebGis)
