...
Module Module1
    ...
    Public RunReciveMsgCtlTSS As CtlOnlineTSS
    Public RunReciveMsgCtlTZBQ As CtlOnlineTZBQ
    ...
    End Structure
    Public Function getIDbyBQ(ByVal BQ As String)
        Try
    ...
    End Function
    Public Function BCD2Int(ByVal BCD As String) As Integer
        Try
    ...
    Public Function DSGBase2PPSJValues(ByVal base64 As String) As Double()
        ...
        Return Nothing
    End Function
    Public Function GetLen(ByVal k As Double) As String
        Dim str As String = ""
        If k < 1024 Then
