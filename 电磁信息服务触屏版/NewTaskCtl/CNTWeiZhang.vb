...
Public Class CNTWeiZhang
    ...
    End Structure
    Private Sub CNTWeiZhang_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.BackColor = Color.Transparent
        Me.Dock = DockStyle.Fill
        txtTaskNickName10.Text = "违章捕获" & Now.ToString("yyyyMMddHHmmss")
